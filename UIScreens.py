...
def deckScreen(deckList):
    # Show the list of decks, and the template for displaying card details
        ...
        deckCard = [[sg.Text(size=(500,1), key='-DECK-')],
                    ...
                    [sg.Text(' ' * 8),
                     sg.Button('Again', size=(10,2), button_color=('grey99', 'red2')),
                     sg.Button('Hard', size=(10,2), button_color=('grey99', 'dark orange')),
                     sg.Button('Good', size=(10,2), button_color=('grey99', 'green3')),
                     sg.Button('Easy', size=(10,2), button_color=('grey99', 'DeepSkyBlue3'))]]
        
        flipButton = [[sg.Button('Flip', size=(10,4))]]
